...
<h1>Kategori Penyanyi Solo <br>Perempuan</h1>

<?php
$sql = "SELECT * FROM penyanyi_perempuan";
...
while ($row = mysqli_fetch_assoc($result)) {
    echo '<div class="artist-card">
        ...
        <div class="ticket-box">
            ...
            <a href="memilih tiket.php?asal_tabel=perempuan&id=' . $row['id'] . '"><button>Buy Tickets Now</button></a>
        </div>
    </div>';
}
?>
